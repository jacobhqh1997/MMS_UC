...
import sys
sys.path.append('./')
from Networks.Local_networks import resnext50_32x4d
...
checkpoint = torch.load('path/to/global_pth.pkl') #trained MacroContextNet model
...
if __name__ == '__main__':
    macro_test= 'path/to/global_save/'
    ...
    for epoch in tqdm(range(EPOCH)):
        ...
        for batch_idx, batch in enumerate(val_loader):
            ...
            save_path = os.path.join('path/to/global/pt/', filename)
