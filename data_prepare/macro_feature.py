...
import sys
sys.path.append('./')
from Networks.Macro_networks_nll import resnext50_32x4d
...
checkpoint = torch.load('path/to/macro_pth.pkl') #trained MacroContextNet model
...
if __name__ == '__main__':
    macro_test= 'path/to/Macro_processed/'
    ...
    for epoch in tqdm(range(EPOCH)):
        ...
        for batch_idx, batch in enumerate(val_loader):
            ...
            save_path = os.path.join('path/to/macro/pt/', filename)
